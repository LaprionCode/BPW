                            ...
                            <div class="card-body">
                                <form action="" method="POST">
                                    ...
                                    <label for="stok">Nama Barang</label>
                                        <input name="stok" value="<?= $sembako['nama']; ?>" type="text" readonly class="form-control" id="nama">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="stok" value="<?= $sembako['harga']; ?>" type="text" readonly class="form-control" id="harga">
                                    </div>
                                    <div class="form-group">
