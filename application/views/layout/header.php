    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Jod <sup>2023</sup></div>
            </a>
            ...
            <?php
            if($user['role'] == 'Admin') { ?>
            <li class="nav-item"><a class="nav-link" href="<?= site_url('dashboard/') ?>">
            ...
            if ($user['role'] == "Admin") { ?>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="<?= site_url('Sembako/') ?>">
                        <i class="fas fa-fw fa-users"></i>
                        <span>Sembako</span>
                    </a>
                    <li class="nav-item">
            ...
            ?>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="<?= site_url('profil/sembako') ?>">
                        <i class="fas fa-fw fa-users"></i>
                        <span>Sembako</span>
                      </a>
            <li class="nav-item">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- delete again pertemuan 11 Nav Item - Alerts 
                        <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        -->
                        <!-- delet delet delet delet            pertemuan 11 Nav Item - Messages -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                ...
                                <a class="dropdown-item" href="<?= base_url('index.php/Auth') ?>" data-toggle="modal" data-target="#logoutModal">
