...
class profil extends CI_Controller
{
    ...
    public function sembako()
    {
      ...
      $data['jlh'] = $this->Keranjang_model->jumlah();
      $this->load->view("layout/header", $data);
      $this->load->view("profil/vw_sembako_pro", $data);
      $this->load->view("layout/footer", $data);
    }
    ...
    public function keranjang($id)
    {
      ...
      if ($this->form_validation->run() == false) {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Data Sembako berhasil ditambahkan ke keranjang!</div>');
  ...
  Berhasil dihapus dari keranjang</div>');
      redirect('Profil/detail');
    }
